...
public class ChineseToEnglishTranslator {
        private final String chineseWordToTranslateToEnglish;
        private final String wordTranslatedToEnglish;
        public ChineseToEnglishTranslator(String chineseWordToTranslateToEnglish) throws IOException, InterruptedException{
            this.chineseWordToTranslateToEnglish = chineseWordToTranslateToEnglish;
        ...
        private String requestTranslation() throws IOException, InterruptedException {
            ...
            HttpRequest request = HttpRequest.newBuilder()
                    ...
                    .method("POST", HttpRequest.BodyPublishers.ofString("source_language=zh-CN&target_language=en&text="+chineseWordToTranslateToEnglish))
                    .build();
