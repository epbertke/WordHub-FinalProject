...
public class PortugueseToFrenchTranslator {
    private final String portugueseWordToTranslateToFrench;
    ...
    public PortugueseToFrenchTranslator(String userWordToTranslate) throws IOException, InterruptedException {
        this.portugueseWordToTranslateToFrench = userWordToTranslate;
    ...
    private String requestTranslation() throws IOException, InterruptedException {
        ...
        HttpRequest request = HttpRequest.newBuilder()
                ...
                .method("POST", HttpRequest.BodyPublishers.ofString("source_language=pt&target_language=fr&text="+portugueseWordToTranslateToFrench))
                .build();
    ...
    public String findWordTranslatedToFrench(String translationResponse){
        try{
            ...
            if(jsonResultArray.get(0).toString().equals(portugueseWordToTranslateToFrench)){
