...
public class GermanToChineseTranslator {
    private final String germanWordToTranslateToChinese;
    private final String wordTranslatedToChinese;
    public GermanToChineseTranslator(String userWordToTranslate) throws IOException, InterruptedException {
    ...
    private String requestTranslation() throws IOException, InterruptedException {
        ...
        HttpRequest request = HttpRequest.newBuilder()
                ...
                .method("POST", HttpRequest.BodyPublishers.ofString("source_language=de&target_language=zh-CN&text="+germanWordToTranslateToChinese))
                .build();
