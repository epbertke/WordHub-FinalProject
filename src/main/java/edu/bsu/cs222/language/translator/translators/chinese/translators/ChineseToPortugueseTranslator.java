...
public class ChineseToPortugueseTranslator {
    private final String chineseWordToTranslateToPortuguese;
    private final String wordTranslatedToPortuguese;
    public ChineseToPortugueseTranslator(String userWordToTranslate) throws IOException, InterruptedException {
        this.chineseWordToTranslateToPortuguese = userWordToTranslate;
    ...
    private String requestTranslation() throws IOException, InterruptedException {
        ...
        HttpRequest request = HttpRequest.newBuilder()
                ...
                .method("POST", HttpRequest.BodyPublishers.ofString("source_language=zh-CN&target_language=pt&text="+chineseWordToTranslateToPortuguese))
                .build();
    ...
    private String findWordTranslatedToPortuguese(String translationResponse){
        try{
            ...
            if(jsonResultArray.get(0).toString().equals(chineseWordToTranslateToPortuguese)){
