...
public class ChineseToFrenchTranslator {
    private final String chineseWordToTranslateToFrench;
    private final String wordTranslatedToFrench;
    public ChineseToFrenchTranslator(String userWordToTranslate) throws IOException, InterruptedException {
        this.chineseWordToTranslateToFrench = userWordToTranslate;
    ...
    private String requestTranslation() throws IOException, InterruptedException {
        ...
        HttpRequest request = HttpRequest.newBuilder()
                ...
                .method("POST", HttpRequest.BodyPublishers.ofString("source_language=zh-CN&target_language=fr&text="+chineseWordToTranslateToFrench))
                .build();
    ...
    private String findWordTranslatedToFrench(String translationResponse){
        try{
            ...
            if(jsonResultArray.get(0).toString().equals(chineseWordToTranslateToFrench)){
